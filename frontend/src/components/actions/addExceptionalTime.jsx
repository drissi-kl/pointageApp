...
import { ArrowLeft, Save } from 'lucide-react'; // استيراد أيقونات إضافية للمسة جمالية

export default function AddExceptionalTime({showExceptionalTime}) {
    const dayNames = ["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"];

    return (
        <div className="min-h-screen bg-zinc-950 p-6 text-zinc-200">
            {/* Header - تم تحسينه ليتناسب مع النمط الداكن */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-10">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="relative group">
                                ...
                                >
                                    <option value="" className="bg-zinc-950">Choose a day...</option>
                                    {dayNames.map((day, index) => (
                                        <option key={index} value={day} className="bg-zinc-950">{day}</option>
                                    ))}
                                </select>
