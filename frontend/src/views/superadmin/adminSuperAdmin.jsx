  ...
  return (
    <main className="flex-1 bg-zinc-50 dark:bg-zinc-900 min-h-screen p-8">
      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <button className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 shadow-sm transition-all duration-300">
          <UserPlus size={18} />
          Add New Admin
        </button>
      </header>
            ...
            {filteredAdmins.map((admin) => (
              <tr key={admin.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-700/30 transition-colors duration-200 group">
                ...
                <td className="px-6 py-4 text-right">
                  <button className="p-2 hover:bg-zinc-200 dark:hover:bg-zinc-600 rounded-lg transition-colors">
